import 'package:astrotak/bloc/astrotakbloc_bloc.dart';
...
class _AskQuestionState extends State<AskQuestion> {
  ...
  final questions = ['ferafsd', '2'];

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => AstrotakblocBloc(),
                  ...
                  child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          BlocBuilder<AstrotakblocBloc, AstrotakblocState>(
                              builder: (context, state) {
                            if (state is AstrotakInprogress)
                              return Center(
                                child: CircularProgressIndicator(),
                              );
                            else if (state is AstrotakFailure)
                              return Center(
                                child: Text("Something went wrong"),
                              );
                            else if (state is AstrotakSuccess)
